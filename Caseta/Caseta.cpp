...
// Caseta.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CCasetaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CCasetaApp

CCasetaApp::CCasetaApp()
{
...
// Único objeto CCasetaApp

CCasetaApp theApp;


// Inicialización de CCasetaApp

BOOL CCasetaApp::InitInstance()
{
